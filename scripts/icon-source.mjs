/** Existing Synap symbol geometry, shared by generated public assets. */
export const SYNAP_MARK = `
...
export function synapFaviconSvg(size) {
  return `<svg xmlns="http://www.w3.org/2000/svg" width="${size}" height="${size}" viewBox="0 0 24 24">
  <circle cx="12" cy="12" r="11" fill="#FFFFFF"/>
  <g transform="translate(12 12) scale(0.78) translate(-12 -12)">${SYNAP_MARK}
  </g>
</svg>`;
}
