...
export const PUBLIC_PAGE_CONTENT: Record<ContentPagePath, Record<Locale, PublicPageContent>> = {
      ...
      sections: [
        {
          ...
          paragraphs: [
            "Жобада бизнестің атауы мен санаты, қажет болса сайт, қала, нарық, атау нұсқалары және белгілі бәсекелестер сақталады. Бұл мәліметтер қажетті нысанды анықтауға және орынды сұрақтар жасауға көмектеседі, бірақ клиенттің жария профиліне айналмайды.",
        ...
        {
          heading: "Нысандар мен бәсекелестер тексеруді талап етеді",
          paragraphs: [
        ...
        },
        {
          ...
          table: {
            ...
            rows: [
              ...
              ["Бәсекелестік қима", "Сұраныс бойынша домендер", "Көптеген жауаптардағы нысандар"],
      ...
      sections: [
        ...
        },
        {
          ...
          bullets: [
            ...
            "Сайттың аралауға қолжетімділігін және машиналарға нысан айқындығын жақсарту.",
      ...
      sections: [
        {
          ...
          paragraphs: [
            "Иесі атау мен санатты, қажет болса сайтты, қаланы, атау нұсқаларын және бес белгілі бәсекелеске дейін көрсетеді. Нарық орыс және ағылшын сұрақтарының арақатынасын белгілейді. Бұл өрістер мақсатты нысанды анықтайды және жария профильге айналмайды.",
          ],
        },
        {
        ...
        },
        {
          ...
          paragraphs: [
            ...
            "Akrux белгілі нысандарды және олардың шығу ретін салыстырады, қосымша компания атауларын шығара алады, кең тараған бәсекелес емес нысандарды сүзеді, дереккөздерді сақтайды және нұсқаланған метрикаларды есептейді. Қате сұраныстар қате күйінде қалады және бөлгіштерге кірмейді.",
          ],
        },
        {
    ...
    kk: kkPhase2b({
      ...
      sections: [
        ...
        },
        {
          ...
          paragraphs: [
            "Белгілі нысандар нормаланған атау нұсқалары, орысша-ағылшынша транслитерация және консервативті бұлыңғыр сәйкестік арқылы табылады. Мақсаттың позициясы — жауапта танылған бизнес-нысандардың шығу реті. Оң детерминистік сәйкестік тілдік модель өтуінен басым.",
            "Топтық шығару реңк пен белгісіз компания атауларын қоса алады. Ол табылған детерминистік аталымды жоймайды. Жауаптағы бір нысанның қайталануы дауыс үлесі үшін бір рет есептеледі.",
          ],
        },
        {
        ...
        },
        {
          ...
          paragraphs: [
            "Akrux сәтті брендсіз жауаптарды пайдаланады. Әр қолайлы бизнес-нысан бір жауапқа бір реттен артық есептелмейді; оның саны барлық қолайлы аталымдардың қосындысына бөлінеді. Берілген бәсекелестер кестеде нөлмен қалады, ал жаңа нысандар жіктеуден өтеді.",
        ...
        },
        {
          ...
          bullets: [
            ...
            "Нысандарды шығару мен бәсекелестерді жіктеу түсініксіз санаттарда тексеруді талап етеді.",
  ...
  "/blogs/ai-visibility-kazakhstan": {
    ...
    kk: kkPhase2b({
      ...
      summary:
        "Қазақстан бизнесі үшін ЖИ-дегі көріну дұрыс нысанды тануды, орынды жауаптарда шығуды, ұсыныстар ретін, сипаттама дәлдігін, бәсекелестерді және дәйексөз алынған дәлелдерді қамтиды. Әр аудит тұрақты позиция емес, күні көрсетілген таңдама болып қалады.",
      sections: [
        {
          ...
          table: {
            ...
            rows: [
              ...
              ["Өлшенетін нысан", "Бет немесе домен", "Бизнес, өнім немесе ұйым"],
        ...
        },
        {
          ...
          paragraphs: [
            "Брендтік сұрақ компанияны атап, танымалдықты тексереді: жүйе нысанды дұрыс анықтап, сипаттай ма. Брендсіз сұрақ компания атауынсыз санат, міндет, салыстыру немесе орын туралы сұрап, орынды нұсқалар арасында табылуды тексереді.",
        ...
        },
        {
          ...
          bullets: [
            ...
            "Орыс, қазақ және ағылшын тіліндегі жария дереккөздер нысан мен ұсынысты бірдей сипаттай ма, тексеріңіз.",
  ...
  "/generative-engine-optimization": {
    ...
    kk: kkPhase2b({
      ...
      lead:
        "Generative Engine Optimization, немесе GEO, — бизнес туралы жария ақпаратты жауап жасайтын жүйелерге табуға, дұрыс нысанмен салыстыруға, тексеруге және дәйексөз алуға ыңғайлы ететін қолмен жасалатын жұмыс.",
      summaryTitle: "Практикалық анықтама",
      summary:
        "GEO қолжетімді мазмұнды, техникалық SEO-ны, нысан үйлесімділігін, пайдалы жауаптарды, бастапқы дәлелдерді және жасалған нәтижелерді өлшеуді біріктіреді. Ол оқыту деректеріне түсуге немесе ұсынылуға кепілдік бермейді.",
      ...
      sections: [
        {
          ...
          paragraphs: [
            ...
            "Қосымша назар — нысан мен жауап айқындығы: бет бұл қандай өнім екенін, оны кім жариялайтынын, қандай мәселені шешетінін, мәлімдемелерді қалай тексеруге болатынын және әдістемені қайдан табуға болатынын тікелей айтуы тиіс.",
          ],
        },
        {
        ...
        },
        {
          heading: "Akrux рөлі",
          paragraphs: [
            "Akrux аудиті сұрақтар мен жауаптар таңдамасын сақтайды, бренд танымалдығын брендсіз табылудан ажыратады, бәсекелес нысандар мен дереккөздерді анықтайды және нұсқаланған метрикаларды есептейді. Қоңыраудан кейін команда бұл деректерді келісілген жұмысты жоспарлау және қолмен орындау үшін пайдалана алады.",
      ...
      related: [
        ...
        { path: "/blogs/audit-ai-generated-brand-information", label: "Нысанның нақты аудиті" },
      ],
    }),
  },
  "/use-cases": {
      ...
      sections: [
        ...
        },
        {
          ...
          paragraphs: [
            ...
            "Аудит сұрақтарды, жауаптар таңдамасын, нысандарды, позициялар мен дереккөздерді сақтайды. Ол кәсіби біліктілікті тексермейді және жауапты сертификаттамайды; сезімтал фактілерді құзыретті адам бағалауы тиіс.",
          ],
          examples: [
        ...
        },
        {
          ...
          bullets: [
            "Бизнес-нысан мен атау нұсқаларын нақты анықтаңыз.",
      ...
      sections: [
        {
          ...
          paragraphs: [
            ...
            "Ескі атауларды, карталардағы қайталанатын карточкаларды, әртүрлі санаттарды және атауы ұқсас компанияларды тексеріңіз. Үйлесімділік қажетті нысанды анықтауға көмектеседі, бірақ ЖИ жауабында шығуға кепілдік бермейді.",
          ],
        },
        {
        ...
        },
        {
          ...
          paragraphs: [
            "Бәсекелестің шығуы сұраққа жақсырақ сәйкестікпен, айқынырақ жергілікті дәлелдермен, бірыңғай нысанмен немесе модельдің әдеттегі өзгергіштігімен түсіндірілуі мүмкін. Табылған әр атауды нақты бәсекелес деп есептеместен бұрын бастапқы жауапты тексеріңіз және карталарды, каталогтарды, маркетплейстер мен қауымдастықтарды жұмыс істеп тұрған компаниялардан ажыратыңыз.",
    ...
    kk: kkPhase2b({
      ...
      sections: [
        ...
        },
        {
          ...
          paragraphs: [
            "Жабық есепті қарағаннан кейін иесі қоңырауға жазыла алады. Akrux қолмен жұмысты ұсына алады: нысан туралы жария фактілерді түзету, сайтты аралауды жақсарту, пайдалы ақпаратты күшейту немесе дереккөздердегі олқылықтарды талдау. Баға, жұмыс нәтижесі және мерзімдер бөлек келісіледі және тегін аудиттен тумайды.",
      ...
      sections: [
        {
          ...
          paragraphs: [
            "Иесі іздеу позицияларын көре алады, бірақ компания жоқ, басқа нысанмен шатастырылған немесе әлсіз дереккөздер бойынша сипатталған нақты ЖИ жауаптарын көрмейді. Akrux күні көрсетілген дәлелдер жиынын жасайды: сұрақтар, жауаптар таңдамасы, бизнестің шығуы, бәсекелестер және дереккөздер.",
          ],
        },
        {
    ...
    kk: kkPhase2b({
      ...
      sections: [
        ...
        },
        {
          ...
          paragraphs: [
            "Бәсекелестер бөлімінде берілген қарсыластар мен жіктеуден өткен жаңа нысандар табылады. Дауыс үлесі сәтті брендсіз жауаптардағы қолайлы аталымдарды есептейді. «Қай жерде ұтыласыз» мақсатсыз, бәсекелесі бар сұрақтарды көрсетеді; бұл — жоғалған клиенттің дәлелі емес, басымдық белгілеу.",
          ],
        },
        {
          ...
          bullets: [
            ...
            "Нысандар мен реңкті шығару адам тексеруін талап етуі мүмкін.",
  ...
  "/blogs/audit-ai-generated-brand-information": {
    ...
    kk: kk({
      ...
      lead:
        "Пайдалы аудит нысан мен тұжырымдарды әр жауап бойынша тексереді, дәлдікті бір санға түйіндемейді.",
      summaryTitle: "Аудит нәтижесі",
      summary:
        "Күні көрсетілген кесте жасаңыз: нақты сұрақ, модель отбасы, жауаптың тұжырымы, танылған нысан, дереккөз, тексеру нәтижесі және түзетілетін дереккөздің иесі.",
      published: "2026 жылғы 2 тамыз",
      sections: [
        {
          heading: "1. Мақсатты нысанды анықтаңыз",
          bullets: [
        ...
        },
        {
          ...
          bullets: [
            "Дұрыс нысан: жауап дәл осы бизнес туралы ма?",
        ...
        },
        {
          ...
          paragraphs: [
            "Алдымен өз индекстелетін беттеріңізді, содан кейін бизнес бақылайтын профильдер мен каталогтарды түзетіңіз. Нысанның бір анықтамасын пайдаланыңыз және егжей-тегжейлі мәлімдемелерді құжаттамамен байланыстырыңыз. Жалған сыртқы сілтемелер жасамаңыз.",
          ],
        },
        {
  ...
  "/blogs/why-ai-recommends-competitors": {
    ...
    kk: kk({
      ...
      lead:
        "Бәсекелес сұраққа жақсырақ сәйкестікке, айқынырақ дәлелдерге, нысанды оңай сәйкестендіруге немесе нақты іске қосудың өзгергіштігіне байланысты шығуы мүмкін.",
      summaryTitle: "Бәрін бір себепке саймаңыз",
      summary:
        "Санатқа сәйкестік, дәлелдер, нысан айқындығы және модель өзгергіштігі арасында таңдамас бұрын нақты сұрақты, жауапты, ұсыныстар ретін және дереккөздерді бірнеше орынды сұрақ бойынша салыстырыңыз.",
      published: "2026 жылғы 2 тамыз",
      sections: [
        {
          ...
          bullets: [
            ...
            "Нысан: атаулар, сипаттамалар және профильдер тұрақты түрде бір ұйымды көрсетеді.",
  ...
  "/changelog": {
      ...
      sections: [
        {
          ...
          bullets: [
            "Unified the public product name as Akrux.",
      ...
      sections: [
        {
          ...
          bullets: [
            "Публичное название унифицировано как Akrux.",
    ...
    kk: kk({
      ...
      summary:
        "2026 жылғы 2 тамызда өнім Akrux брендіне көшті және аралау мен тексеруге арналған нысан мен әдістеменің жария қос тілді қабатын алды.",
      sections: [
        {
          heading: "2026 жылғы 2 тамыз — жария нысан және әдістеме",
          bullets: [
            "Жария атау Akrux ретінде біріздендірілді.",
      ...
      sections: [
        {
          ...
          bullets: [
            ...
            "Жасалған сұрақтар, провайдер жауаптары, сілтемелер, нысандар, күй, құн деректері және есеп метрикалары.",
    ...
    kk: kk({
      ...
      sections: [
        ...
        },
        {
          ...
          paragraphs: [
            "Жауаптар толық емес, дәл емес, өзгермелі немесе қолжетімсіз болуы мүмкін. Нысандарды, реңкті және бәсекелестерді шығару тексеруді талап етуі мүмкін. Сервис индекстеуге, оқыту деректеріне түсуге, дәйексөзге, ұсынысқа, коммерциялық нәтижеге немесе провайдердің тұрақты қолжетімділігіне кепілдік бермейді.",
          ],
        },
        {
